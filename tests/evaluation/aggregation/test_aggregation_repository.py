...
from pharia_studio_sdk.evaluation.aggregation.hugging_face_aggregation_repository import (
...
def mocked_hugging_face_aggregation_repository(
    ...
    class_to_patch = "pharia_studio_sdk.evaluation.aggregation.hugging_face_aggregation_repository.HuggingFaceAggregationRepository"
    with (
